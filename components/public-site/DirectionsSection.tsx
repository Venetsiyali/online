'use client';
import { GraduationCap, Palette, Monitor, Clock, Award, ChevronRight } from 'lucide-react';
...
const directions = [
  {
    ...
    desc: 'Vektor grafika, logo yaratish, reklama materiallari va professional dizayn asoslarini o\'rganing.',
    duration: '6 oy',
  ...
  },
  {
    ...
    desc: 'Zamonaviy kompyuter dasturlari, Microsoft Office, internet va raqamli texnologiyalarni o\'zlashtiring.',
    duration: '6 oy',
    price: '300,000 so\'m/oy',
    cert: 'Sertifikat beriladi',
    skills: ['MS Word & Excel', 'PowerPoint', 'Internet ishlash', 'E-mail', 'Canva asoslari'],
    level: 'Boshlang\'ich',
  },
];
